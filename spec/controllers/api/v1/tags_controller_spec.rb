...
describe Api::V1::TagsController do
  ...
  describe "GET index" do
    it "assigns all api_v1_tags as @api_v1_tags" do
      tag = Api::V1::Tag.create! valid_attributes
      get :index, {}, valid_session
      assigns(:api_v1_tags).should eq([tag])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new api_v1 as @api_v1" do
      ...
      assigns(:api_v1).should be_a_new(Api::V1::Tag)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created api_v1 as @api_v1" do
        post :create, {:api_v1 => valid_attributes}, valid_session
        assigns(:api_v1).should be_a(Api::V1::Tag)
        assigns(:api_v1).should be_persisted
      end

      it "redirects to the created api_v1" do
        post :create, {:api_v1 => valid_attributes}, valid_session
        response.should redirect_to(Api::V1::Tag.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved api_v1 as @api_v1" do
        ...
        Api::V1::Tag.any_instance.stub(:save).and_return(false)
        post :create, {:api_v1 => { "text" => "invalid value" }}, valid_session
        assigns(:api_v1).should be_a_new(Api::V1::Tag)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested api_v1" do
        tag = Api::V1::Tag.create! valid_attributes
        # Assuming there are no other api_v1_tags in the database, this
        # specifies that the Api::V1::Tag created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Api::V1::Tag.any_instance.should_receive(:update).with({ "text" => "MyString" })
        put :update, {:id => tag.to_param, :api_v1 => { "text" => "MyString" }}, valid_session
      end

      it "assigns the requested api_v1 as @api_v1" do
        tag = Api::V1::Tag.create! valid_attributes
        put :update, {:id => tag.to_param, :api_v1 => valid_attributes}, valid_session
        assigns(:api_v1).should eq(tag)
      end
    ...
    describe "with invalid params" do
      it "assigns the api_v1 as @api_v1" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Api::V1::Tag.any_instance.stub(:save).and_return(false)
        put :update, {:id => tag.to_param, :api_v1 => { "text" => "invalid value" }}, valid_session
        assigns(:api_v1).should eq(tag)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the api_v1_tags list" do
      tag = Api::V1::Tag.create! valid_attributes
      delete :destroy, {:id => tag.to_param}, valid_session
      response.should redirect_to(api_v1_tags_url)
    end
  end

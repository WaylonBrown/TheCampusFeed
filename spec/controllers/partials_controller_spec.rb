  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved partial as @partial" do
        ...
        post :create, {:partial => { "name" => "invalid value" }}, valid_session
        assigns(:partial).should be_a_new(Partial)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested partial" do
        ...
        Partial.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => partial.to_param, :partial => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the partial as @partial" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Partial.any_instance.stub(:save).and_return(false)
        put :update, {:id => partial.to_param, :partial => { "name" => "invalid value" }}, valid_session
        assigns(:partial).should eq(partial)
      end

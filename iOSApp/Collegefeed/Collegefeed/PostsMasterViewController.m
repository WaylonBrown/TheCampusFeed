...
/*
@interface PostsMasterViewController ()

@end
*/

@implementation PostsMasterViewController
...
- (void)viewDidLoad
{
    ...
    // next line should be in awakeFromNib method (not here, maybe deprecated?)

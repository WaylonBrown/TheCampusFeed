  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved flag as @flag" do
        ...
        post :create, {:flag => { "votable" => "invalid value" }}, valid_session
        assigns(:flag).should be_a_new(Flag)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested flag" do
        ...
        Flag.any_instance.should_receive(:update).with({ "votable" => "" })
        put :update, {:id => flag.to_param, :flag => { "votable" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the flag as @flag" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Flag.any_instance.stub(:save).and_return(false)
        put :update, {:id => flag.to_param, :flag => { "votable" => "invalid value" }}, valid_session
        assigns(:flag).should eq(flag)
      end
